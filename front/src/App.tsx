...
function App() {
  ...
  const isValidGmail = /^[^\s@]+@gmail\.com$/i.test(gmail.trim())
  ...
  const startGoogleLogin = () => setShowGmailStep(true)
  const completeGoogleLogin = () => {
    if (!isValidGmail) {
      setNotice('Informe um endereço Gmail válido para continuar.')
      return
    }
